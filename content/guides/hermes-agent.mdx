...
本文同步自橙皮书小册《Hermes Agent 从入门到精通》（花叔），并配干净概念图。正文骨架对齐 **Hermes Agent v0.7.0**；文末附录用白话补齐 Agent Harness 深读，以及 **v0.7 → v0.19.1** 的版本演进。

原 PDF：[下载](/guides/Hermes-Agent.pdf)

插图目录：`/guides/hermes-agent/`。

> AI 工具迭代很快，安装与安全细节请以 [官方文档](https://hermes-agent.nousresearch.com/) / [Changelog](https://hermes-ai.net/changelog/) 为准。
...
Figures live under `/guides/hermes-agent/`. For the full narrative voice and tables, switch to 中文; English below mirrors the outline with matching diagrams.
## Contents
...
![§01 Not Another Agent: From Harness to Hermes](/guides/hermes-agent/01-harness-five.svg)
...
![§02 Hermes at a Glance](/guides/hermes-agent/02-architecture.svg)
...
![§03 The Learning Loop](/guides/hermes-agent/03-learning-loop.svg)
...
![§04 Three-Layer Memory](/guides/hermes-agent/04-three-memory.svg)

## §05 Skills That Evolve

Skills are markdown SOPs under ~/.hermes/skills/. They can be created and edited by the agent from feedback—not static docs.

![§05 Skills That Evolve](/guides/hermes-agent/05-skill-evolve.svg)

## 触发条件

See the Chinese edition for full detail.
...
![§06 Tools & MCP](/guides/hermes-agent/06-tools-mcp.svg)

![§06 Tools & MCP](/guides/hermes-agent/07-subagents.svg)
...
![§09 Multi-Platform Gateway](/guides/hermes-agent/08-gateway.svg)
...
![§16 Hermes vs OpenClaw vs Claude Code](/guides/hermes-agent/09-three-species.svg)

## §17 Boundaries of Self-Improving Agents

Let agents improve “how”; you keep “what” and “never.” Stay on the loop for direction.

![§17 Boundaries of Self-Improving Agents](/guides/hermes-agent/10-control-loop.svg)

## Appendix · Agent Harness Deep Dive

Harness = OS around the LLM. Twelve components, TAO loop, seven design decisions—mapped back to Hermes.

![Appendix · Agent Harness Deep Dive](/guides/hermes-agent/14-os-metaphor.svg)

![Appendix · Agent Harness Deep Dive](/guides/hermes-agent/11-three-layers.svg)

![Appendix · Agent Harness Deep Dive](/guides/hermes-agent/12-tao-loop.svg)

![Appendix · Agent Harness Deep Dive](/guides/hermes-agent/13-seven-decisions.svg)

## Appendix · Version Evolution (v0.7 → v0.19)

Apr–Jul 2026: from terminal wrapper to durable personal AI infra. Velocity → Surface → Quicksilver.

![Appendix · Version Evolution (v0.7 → v0.19)](/guides/hermes-agent/15-version-phases.svg)

![Appendix · Version Evolution (v0.7 → v0.19)](/guides/hermes-agent/17-six-pillars.svg)

![Appendix · Version Evolution (v0.7 → v0.19)](/guides/hermes-agent/16-kernel-slim.svg)
