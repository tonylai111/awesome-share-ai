...
description:
  ...
  en: "The agent that ships with a harness. Learning loops, three-layer memory, Skills, MCP, Gateway—plus Harness deep dive and v0.7→v0.19 evolution."
date: "2026-08-02"
...
This guide is adapted from the Chinese handbook *Hermes Agent: From Zero to Fluent* (花叔 / 橙皮书系列), based on **v0.7.0**, with appendices covering Harness theory and evolution through **v0.19.1**.

Original PDF: [Download](/guides/Hermes-Agent.pdf)

> AI tools move fast—treat [official docs](https://hermes-agent.nousresearch.com/) / [Changelog](https://hermes-ai.net/changelog/) as source of truth. Core chapters follow Hermes Agent **v0.7.0**; the evolution appendix catches up in plain English to **v0.19.1** (2026-07-30).

For the full narrative voice and tables, switch to 中文; English below mirrors the outline with matching diagrams.
...
- [§02 Hermes at a Glance](#02-hermes-at-a-glance)
- [§03 The Learning Loop](#03-the-learning-loop)
- [§04 Three-Layer Memory](#04-three-layer-memory)
- [§05 Skills That Evolve](#05-skills-that-evolve)
- [§06 Tools & MCP](#06-tools-mcp)
- [§07 Install & Configure](#07-install-configure)
- [§08 First Conversation](#08-first-conversation)
- [§09 Multi-Platform Gateway](#09-multi-platform-gateway)
- [§10 Custom Skills](#10-custom-skills)
- [§11 MCP Integration](#11-mcp-integration)
- [§12 Personal Knowledge Assistant](#12-personal-knowledge-assistant)
- [§13 Dev Automation](#13-dev-automation)
- [§14 Content Creation](#14-content-creation)
- [§15 Multi-Agent Orchestration](#15-multi-agent-orchestration)
- [§16 Hermes vs OpenClaw vs Claude Code](#16-hermes-vs-openclaw-vs-claude-code)
- [§17 Boundaries of Self-Improving Agents](#17-boundaries-of-self-improving-agents)
- [Appendix · Agent Harness Deep Dive](#appendix-agent-harness-deep-dive)
- [Appendix · Version Evolution (v0.7 → v0.19)](#appendix-version-evolution-v07-v019)

---

## §01 Not Another Agent: From Harness to Hermes

Hermes is not “another lobster.” It productizes Harness Engineering: the straps around the model become built-in, and can grow by themselves.

![§01 Not Another Agent: From Harness to Hermes](/guides/hermes-agent/01-harness-five.en.svg)

## §02 Hermes at a Glance

One line architecture: learning loop → three-layer memory → Skills → 40+ tools → multi-platform Gateway. Cheap to run, open source (MIT).

![§02 Hermes at a Glance](/guides/hermes-agent/02-architecture.en.svg)

## §03 The Learning Loop

Five linked stages: curate memory → create Skills → improve Skills → FTS5 recall → user modeling. Use it daily and the flywheel spins.

![§03 The Learning Loop](/guides/hermes-agent/03-learning-loop.en.svg)

## §04 Three-Layer Memory

Session / persistent / Skill memory (episodic · semantic · procedural). Optional Honcho modeling. Search with FTS5, think with the model.

![§04 Three-Layer Memory](/guides/hermes-agent/04-three-memory.en.svg)

## §05 Skills That Evolve

Skills are markdown SOPs under ~/.hermes/skills/. They can be created and edited by the agent from feedback—not static docs.

![§05 Skills That Evolve](/guides/hermes-agent/05-skill-evolve.en.svg)

## §06 Tools & MCP

Five tool families + MCP for 6000+ apps. Enable Toolsets on demand; delegate up to three sub-agents with restricted tools.

![§06 Tools & MCP](/guides/hermes-agent/06-tools-mcp.en.svg)

![§06 Sub-agent delegation](/guides/hermes-agent/07-subagents.en.svg)

## §07 Install & Configure

Local script, Docker, or a ~$5 VPS. Production later shifted to Docker First—see the evolution appendix.

## §08 First Conversation

Just talk. Memory and Skills start forming without a setup wizard.

## §09 Multi-Platform Gateway

One Gateway, many surfaces (Telegram, Discord, Slack…). Same brain across channels.

![§09 Multi-Platform Gateway](/guides/hermes-agent/08-gateway.en.svg)

## §10 Custom Skills

Hand-write Skills, install from hub, or port Claude Code skills. Trigger conditions matter.

## §11 MCP Integration

stdio or HTTP MCP servers. Prefer native tools when Hermes already has them; use MCP for your stack.

## §12 Personal Knowledge Assistant

Multi-week projects stay coherent because retrieval is cross-session, not a blank chat each time.

## §13 Dev Automation

Pair with Claude Code: interactive coding vs background watchers, review, and digests.

## §14 Content Creation

Parallel research with sub-agents; Skills accumulate your writing style over a series.

## §15 Multi-Agent Orchestration

delegate_task with isolation, durable ledgers (later versions), and careful tool scopes.

## §16 Hermes vs OpenClaw vs Claude Code

Three species, one ecosystem. Hermes drives; OpenClaw can contain; Claude Code pairs interactively.

![§16 Hermes vs OpenClaw vs Claude Code](/guides/hermes-agent/09-three-species.en.svg)

## §17 Boundaries of Self-Improving Agents

Let agents improve “how”; you keep “what” and “never.” Stay on the loop for direction.

![§17 Boundaries of Self-Improving Agents](/guides/hermes-agent/10-control-loop.en.svg)

## Appendix · Agent Harness Deep Dive

Harness = OS around the LLM. Twelve components, TAO loop, seven design decisions—mapped back to Hermes.

![Appendix · Agent Harness Deep Dive](/guides/hermes-agent/14-os-metaphor.en.svg)

![Appendix · three engineering layers](/guides/hermes-agent/11-three-layers.en.svg)

![Appendix · TAO / ReAct loop](/guides/hermes-agent/12-tao-loop.en.svg)

![Appendix · seven Harness decisions](/guides/hermes-agent/13-seven-decisions.en.svg)

## Appendix · Version Evolution (v0.7 → v0.19)

Apr–Jul 2026: from terminal wrapper to durable personal AI infra. Velocity → Surface → Quicksilver.

![Appendix · Version Evolution (v0.7 → v0.19)](/guides/hermes-agent/15-version-phases.en.svg)

![Appendix · six capability pillars](/guides/hermes-agent/17-six-pillars.en.svg)

![Appendix · kernel slimdown](/guides/hermes-agent/16-kernel-slim.en.svg)
